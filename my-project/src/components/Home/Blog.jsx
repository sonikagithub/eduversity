...
const Blog = () => {
  ...
  const blogPosts = [
    {
      ...
      description:
        "Learn the fundamentals of React and how to build your first application with this powerful JavaScript library.",
      image:
    ...
    },
    {
      ...
      description:
        "Discover how to create beautiful, responsive designs quickly with Tailwind CSS utility-first framework.",
      image:
  ...
  const handleCardClick = (post) => {
    navigate(`/blog/${post.id}`, { state: post }); // ✅ passing blog data through route state
  };
        ...
        <div className="flex justify-between items-center mb-12">
          <div>
            <h1 className="text-4xl font-bold text-gray-900">
              Recent <span className="text-red-500">Blogs</span>
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post) => (
            <div
              ...
              className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col h-full cursor-pointer"
